...
| Live signed authoritative DNS service | Out of scope | This repo generates a BIND-style zone file only. Live nameservers belong in a separate project; see [RST_DNS.md](RST_DNS.md). |
